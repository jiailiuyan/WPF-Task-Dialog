...
namespace TaskDialogInterop
{
    public partial class TaskDialog
    {
        ...
        public static TaskDialogResult Show(TaskDialogOptions options)
        {
            ...
            if (String.IsNullOrWhiteSpace(options.ExpandedControlText))
                options.ExpandedControlText = "Hide details";
            if (String.IsNullOrWhiteSpace(options.CollapsedControlText))
                options.CollapsedControlText = "Show details";
        ...
        private static TaskDialogResult ShowTaskDialog(TaskDialogOptions options)
        {
            ...
            vtd.ExpandedControlText = options.ExpandedControlText;
            vtd.CollapsedControlText = options.CollapsedControlText;
